            ...
            {selectedCharacter && (
              <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-md border border-gray-100 relative overflow-hidden text-center">
                ...
                <div className="mt-6">
                  ...
                  <div className={`mt-6 p-4 rounded-2xl bg-gradient-to-r ${selectedCharacter.color} text-white shadow-inner`}>
                    <p className="font-baloo font-bold text-lg mb-1 flex items-center justify-center gap-2">
                      <span>✨</span> Why {selectedCharacter.name}?
                    </p>
                    <p className="font-nunito text-sm leading-relaxed text-white/95">
